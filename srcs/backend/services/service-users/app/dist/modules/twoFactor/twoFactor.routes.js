...
const twoFactor_controllers_1 = require("./twoFactor.controllers");
/* ************************************************************************** */
 ...
 *
 */
async function TwoFactorAuth(fastify) {
    const twoFactorAuthController = new twoFactor_controllers_1.TwoFactorAuthController(fastify);
    /******************************************************************************/
